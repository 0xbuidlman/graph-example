...
contract GravatarRegistry {
  event NewGravatar(uint256 id, address indexed owner, string displayName, string imageUrl);
  event UpdatedGravatar(uint id, address indexed owner, string displayName, string imageUrl);
